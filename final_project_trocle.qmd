...
**NHANES**: describe NHANES and the data used
...
**ACS Data:** The ACS data was loaded. A census API key was previously loaded and is not included in this. The data was then cleaned to get the appropriate housing related variables.
